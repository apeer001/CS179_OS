...
extern int fasync_helper(struct inode *, struct file *, int, struct fasync_struc
**);
...
extern void ll_rw_swap_file(int rw, kdev_t dev, unsigned int *b, int nb, char *b
...
extern int generic_file_mmap(struct inode *, struct file *, struct vm_area_struc
*);
